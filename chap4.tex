...
\begin{figure}[!h]
    \subfloat[Layout\label{fig:feasible_world_layout}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{feasible_world}
    }
    \hfill
    \subfloat[Algorithm Performance\label{fig:feasible_world_graph}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{feasible_world_graph}
    }
...
\begin{figure}[!h]
    \subfloat[Layout\label{fig:many_obstacles_feasible_world_layout}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{many_obstacles_feasible_world}
    }
    \hfill
    \subfloat[Algorithm Performance\label{fig:many_obstacles_feasible_world_graph}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{many_obstacles_world_graph}
    }
...
\begin{figure}[!h]
    \subfloat[Layout\label{fig:two_soda_world_layout}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{two_soda_world}
    }
    \hfill
    \subfloat[Algorithm Performance\label{fig:two_soda_world_graph}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{two_soda_world_graph}
    }
...
\begin{figure}[!h]
    \subfloat[Layout\label{fig:cluttered_world_layout}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{cluttered_world}
    }
    \hfill
    \subfloat[Algorithm Performance\label{fig:cluttered_world_graph}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{cluttered_world_graph}
    }
...
\begin{figure}[!h]
    \subfloat[Layout\label{fig:top_light_cluttered_world_layout}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{top_light_cluttered_world}
    }
    \hfill
    \subfloat[Algorithm Performance\label{fig:top_light_cluttered_world_graph}]{%
      \includegraphics[width=0.45\textwidth, height = 6cm]{top_light_cluttered_world_graph}
    }
