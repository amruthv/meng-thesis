...
\State Let $q_n \gets$ Closest$(G,k, q_d)$
\State $q \gets Extend-Toward(q_n, q_d, \delta, k)$
\State Let ${q_1, q_2, ..., q_n} \gets$ Neighbors$(G,q)$
\For {$i = 1,2,....n$}
\If{$d(q_i,q) < \delta$}
